...
##### Como primer depurado; se convierte el asignado de la primera variable **Respuesta** a tipo character en consola, pues se considera que con estas cifras no debemos hacer ningún tipo de cálculo matemático como para dejarla ser *entero* ; tambien se convierte a tipo factor las variables en lenguaje binario, representando como *Si* al número *1*
