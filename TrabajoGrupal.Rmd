...
```{r}
boxplot(enc$Q08_PAPA ~ enc$Q03_Carrera, notch= TRUE, col = "lightblue",
...
```
Al revisar los datos y compararlos con lo que pensabamos; refutamos la idea pues es visible que el Promedio académico no esta en función de la edad de los estudiantes; y se puede decir que en ella no existe nigún patrón de interés que responda estas preguntas
