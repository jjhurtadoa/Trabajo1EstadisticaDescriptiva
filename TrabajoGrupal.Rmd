...
```{r,fig.width=7.5, fig.height=6}
 par(oma=c(0,8,0,0))
 plot(enc$Q24_area, enc$Q06_PercentilSaber11, notch=TRUE,
     "p",
     xlab="PERCENTIL DEL ICFES",ylab="AREA",
     
     pch= 19,
     col= ifelse(enc$Q10_Estrato< 3.8, "red", ifelse(enc$Q08_PAPA < 4.042, "darkgoldenrod1", ifelse(enc$Q08_PAPA < 4.3, "forestgreen", "blue"))),
...
```{r,fig.width=7.5, fig.height=6}
 par(oma=c(0,8,0,0))
 plot(enc$Q24_area, enc$Q10_Estrato, notch=TRUE,
     
     xlab="", ylab="Estrato ",
     
     pch= 19,
     col= ifelse(enc$Q06_PercentilSaber11 < 40, "red", ifelse(enc$Q06_PercentilSaber11< 70, "darkgoldenrod1", ifelse(enc$Q06_PercentilSaber11 < 100, "forestgreen", "blue"))),
